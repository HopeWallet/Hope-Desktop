...
/// <summary>
/// Class which contains the data for deriving and creating safe and secure passwords.
/// </summary>
[Serializable]
public class SafePasswordStorage : ScriptableObject
{
    ...
    /// <summary>
    /// Extracts the encryption password from the PlayerPrefs.
    /// </summary>
    ...
    public void SetupPlayerPrefs()
    {
        ...
        prefDictionary.Keys.ForEach(key => PlayerPrefs.SetString(key, prefDictionary[key]));
    }
    ...
    public void PopulatePrefDictionary()
    {
        ...
        keys.SafeForEach(key =>
        {
            if (PlayerPrefs.HasKey(key))
                prefDictionary.Add(key, PlayerPrefs.GetString(key));
        });
    }
