...
public class UIManager : MonoBehaviour, IEscapeButtonObservable
{
	...
	private void SetDefaultSettings()
	{
		...
		SecurePlayerPrefs.SetInt("lock out time", 5);
	...
	public void EscapeButtonPressed(ClickType clickType)
	{
		...
		if (popupManager.AnimatingPopup || popupManager.CloseActivePopup(typeof(LoadingPopup), typeof(TooltipPopup)) || popupManager.ActivePopupExists)
			return;
