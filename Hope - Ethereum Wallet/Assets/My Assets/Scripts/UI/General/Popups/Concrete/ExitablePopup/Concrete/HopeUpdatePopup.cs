...
public sealed class HopeUpdatePopup : OkCancelPopupComponent<HopeUpdatePopup>
{
    ...
    /// </summary>
    protected override void OnStart() => updateAvailableText.text = $"New Hope update available! (v{walletVersionManager.LatestWalletVersion})";

    /// <summary>
    /// Opens the github releases page containing the latest wallet version.
    /// </summary>
    protected override void OnOkClicked() => Application.OpenURL(walletVersionManager.LatestWalletVersionUrl);
}