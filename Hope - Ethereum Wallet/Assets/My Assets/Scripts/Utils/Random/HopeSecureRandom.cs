...
namespace Hope.Utils.Random
{
    ...
    public sealed class HopeSecureRandom : System.Random
    {
        ...
        /// <summary>
        /// Initializes a generic <see cref="HopeSecureRandom"/> instance with no seed or digest.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a <see cref="HopeSecureRandom"/> instance with an array of data used as a seed.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a <see cref="HopeSecureRandom"/> instance with an instance of <see cref="IDigest"/> for our random processing.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a <see cref="HopeSecureRandom"/> instance with an instance of <see cref="IDigest"/> for our random processing and an array of data used as a seed.
        /// </summary>
        /// <param name="randomDigest"> The algorithm to use to use for random processing. </param>
        /// <param name="seedData"> Array of objects to use as our random seed. </param>
