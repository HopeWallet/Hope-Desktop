...
public static class AddressUtils
{
    ...
    /// <returns> True if the string is a valid ethereum address. </returns>
    ...
    /// <summary>
    /// Checks if the input string is of correct length to be an ethereum address.
    /// </summary>
    /// <param name="address"> The address to check. </param>
    ...
    /// <summary>
    /// Checks if the input string has the correct beginning characters to be an ethereum address.
    /// </summary>
    /// <param name="address"> The address to check. </param>
    /// <returns> True if the string starts with '0x'. </returns>
    ...
    /// <summary>
    /// Checks if every char in the string except for the 0x start is a hexadecimal character.
    /// </summary>
    /// <param name="address"> The address to check. </param>
    /// <returns> True if the string has all hex characters. </returns>
